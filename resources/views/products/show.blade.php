    ...
    <div class="bg-white rounded shadow overflow-hidden">
        ...
        <div class="p-4">
            ...
            <div class="mt-4 flex items-center gap-2">
                <a class="px-3 py-2 bg-gray-100 rounded" href="{{ route('products.index') }}">Back</a>
                @auth
                    <a class="px-3 py-2 bg-black text-white rounded" href="{{ route('products.edit', $product) }}">Edit</a>
