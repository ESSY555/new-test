                ...
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <select class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 bg-gray-50 hover:bg-white focus:bg-white">
                        ...
                        <div class="space-y-4">
                            ...
                            <div id="current-image-container" class="{{ $product->image_path ? '' : 'hidden' }}">
                                <div class="relative inline-block">
                                    <img 
                                        id="current-image"
                                        class="h-32 w-32 object-cover rounded-xl border-2 border-gray-200 shadow-md" 
                            ...
                            <div id="new-image-container" class="hidden">
                                <div class="relative inline-block">
                                    <img 
                                        ...
                                        class="h-32 w-32 object-cover rounded-xl border-2 border-green-200 shadow-md" 
                ...
                <div class="bg-gray-50 px-8 py-6 border-t border-gray-100">
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button 
                                type="submit" 
                                class="px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl hover:from-blue-600 hover:to-purple-700 transform hover:scale-105 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl"
                            >
                                <span class="flex items-center">
