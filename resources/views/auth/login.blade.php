                    ...
                    <div class="relative">
                        <div class="flex items-center border rounded overflow-hidden bg-white">
                            ...
                            <button type="button"
                                ...
                                aria-label="Toggle password visibility" data-target="login_password">
                            ...
                            <button class="btn-animate w-full bg-black text-white px-4 py-2 rounded hover:bg-gray-800 cursor-pointer">Login</button>
                            <p class="text-center text-sm">Don't have an account? <a href="{{ route('register') }}"
                                    class="font-semibold hover:underline">Register</a></p>
                            </form>
                            </div>
