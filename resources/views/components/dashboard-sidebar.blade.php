...
<div id="dashboardSidebar"
    class="w-64 bg-white shadow-lg border-r border-gray-200 min-h-screen transition-all duration-300 ease-in-out md:block hidden md:relative md:z-auto fixed top-0 left-0 z-40 transform md:transform-none md:min-h-screen h-screen md:h-auto overflow-y-auto">
    <div class="p-6">
        ...
        <div class="flex justify-between items-start mb-6">
            ...
            <div class="flex items-center space-x-2">
                <!-- Mobile Close Button -->
                <button id="mobileSidebarClose" class="md:hidden text-gray-500 hover:text-gray-700 transition-colors duration-200">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                        </svg>
                        </button>
                        <!-- Desktop Toggle Button -->
                        <button id="sidebarToggle" class="hidden md:block text-gray-500 hover:text-gray-700 transition-colors duration-200">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (mobileSidebarClose && dashboardSidebar) {
        mobileSidebarClose.addEventListener('click', function () {
            if (!dashboardSidebar.classList.contains('hidden')) {
                dashboardSidebar.classList.add('hidden');
                mobileSidebarToggle.innerHTML = '<svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path></svg>';
            }
        });
    }
});
